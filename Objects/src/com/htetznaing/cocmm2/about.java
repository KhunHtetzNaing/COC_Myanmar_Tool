...
public class about extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.cocmm2", "com.htetznaing.cocmm2.about");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.cocmm2", "com.htetznaing.cocmm2.about");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.cocmm2.about", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
_lblname.setText(BA.ObjectToCharSequence("COC Myanmar Tool"));
...
mostCurrent._lstone.AddSingleLine2(BA.ObjectToCharSequence("Translated By : Naung Ye Yint Aung    "),(Object)(1));
 //BA.debugLineNum = 71;BA.debugLine="lstOne.AddSingleLine2 (\"Zawgyi Font Developed By";
mostCurrent._lstone.AddSingleLine2(BA.ObjectToCharSequence("Zawgyi Font Developed By : Kyaw Swar Thwin"),(Object)(3));
 //BA.debugLineNum = 72;BA.debugLine="lstOne.AddSingleLine2 (\"Unicode Font Developed By";
mostCurrent._lstone.AddSingleLine2(BA.ObjectToCharSequence("Unicode Font Developed By : Khon Soe Zaw Thu"),(Object)(8));
 //BA.debugLineNum = 73;BA.debugLine="lstOne.AddSingleLine2 (\"App Developed By : Khun H";
mostCurrent._lstone.AddSingleLine2(BA.ObjectToCharSequence("App Developed By : Khun Htetz Naing"),(Object)(4));
 //BA.debugLineNum = 74;BA.debugLine="lstOne.AddSingleLine2 (\"Website : www.MyanmarAndr";
...
mostCurrent._lstone.AddSingleLine2(BA.ObjectToCharSequence("Facebook : www.facebook.com/MgHtetzNaing   "),(Object)(7));
...
_lblcredit.setText(BA.ObjectToCharSequence("Credits & Thanks All Translator,Designer,Developer!"));
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_facebook.getObject()));
			...
			processBA.setLastException(e7); //BA.debugLineNum = 190;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 191;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"https://m.facebook.";
...
public static String  _interstitial_adclosed() throws Exception{
 //BA.debugLineNum = 262;BA.debugLine="Sub interstitial_AdClosed";
 //BA.debugLineNum = 263;BA.debugLine="Interstitial.LoadAd";
mostCurrent._interstitial.LoadAd();
...
anywheresoftware.b4a.objects.IntentWrapper _facebook = null;
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 217;BA.debugLine="Sub lblCredit_Click";
 //BA.debugLineNum = 218;BA.debugLine="t.Enabled = True";
_t.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 219;BA.debugLine="Try";
try { //BA.debugLineNum = 221;BA.debugLine="Dim Facebook As Intent";
_facebook = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 223;BA.debugLine="Facebook.Initialize(Facebook.ACTION_VIEW, \"fb://";
_facebook.Initialize(_facebook.ACTION_VIEW,"fb://page/627699334104477");
 //BA.debugLineNum = 224;BA.debugLine="StartActivity(Facebook)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_facebook.getObject()));
 } 
       catch (Exception e7) {
			processBA.setLastException(e7); //BA.debugLineNum = 228;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 229;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"https://m.facebook.";
_i.Initialize(_i.ACTION_VIEW,"https://m.facebook.com/MmFreeAndroidApps");
 //BA.debugLineNum = 231;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
...
anywheresoftware.b4a.objects.IntentWrapper _facebook = null;
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 198;BA.debugLine="Sub lbname_Click";
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_facebook.getObject()));
			...
			processBA.setLastException(e7); //BA.debugLineNum = 209;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 210;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"https://m.facebook.";
_i.Initialize(_i.ACTION_VIEW,"https://m.facebook.com/MmFreeAndroidApps");
...
anywheresoftware.b4a.objects.IntentWrapper _facebook = null;
 //BA.debugLineNum = 244;BA.debugLine="Sub lstOnes_ItemClick (Position As Int, Value As O";
 //BA.debugLineNum = 245;BA.debugLine="t.Enabled = True";
_t.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 246;BA.debugLine="Select Value";
switch (BA.switchObjectToInt(_value,(Object)(6),(Object)(7))) {
case 0: {
 //BA.debugLineNum = 248;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.MyanmarAnd";
...
try { //BA.debugLineNum = 251;BA.debugLine="Dim Facebook As Intent";
_facebook = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 252;BA.debugLine="Facebook.Initialize(Facebook.ACTION_VIEW, \"fb:";
_facebook.Initialize(_facebook.ACTION_VIEW,"fb://profile/100006126339714");
 //BA.debugLineNum = 253;BA.debugLine="StartActivity(Facebook)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_facebook.getObject()));
 } 
       catch (Exception e11) {
			processBA.setLastException(e11); //BA.debugLineNum = 255;BA.debugLine="Dim Facebook As Intent";
_facebook = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 256;BA.debugLine="Facebook.Initialize(Facebook.ACTION_VIEW, \"htt";
