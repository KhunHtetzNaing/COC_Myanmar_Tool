...
public class traps extends Activity implements B4AActivity{
	public static traps mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.cocmmtool", "com.htetznaing.cocmmtool.traps");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (traps).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.cocmmtool", "com.htetznaing.cocmmtool.traps");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.cocmmtool.traps", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (traps) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (traps) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (traps) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _ab_click() throws Exception{
 //BA.debugLineNum = 143;BA.debugLine="Sub ab_Click";
 //BA.debugLineNum = 144;BA.debugLine="If p.SdkVersion > 19 Then";
if (mostCurrent._p.getSdkVersion()>19) { 
 //BA.debugLineNum = 145;BA.debugLine="t.Enabled = True";
_t.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 147;BA.debugLine="StartActivity(About)";
...
mostCurrent._activity.setBackground((android.graphics.drawable.Drawable)(mostCurrent._abg.getObject()));
 //BA.debugLineNum = 27;BA.debugLine="If p.SdkVersion > 19 Then";
if (mostCurrent._p.getSdkVersion()>19) { 
...
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 41;BA.debugLine="bg.Initialize(LoadBitmap(File.DirAssets,\"showtrap";
mostCurrent._bg.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"showtraps.png").getObject()));
...
int _i = 0;
 //BA.debugLineNum = 150;BA.debugLine="Sub b1_Click";
 //BA.debugLineNum = 151;BA.debugLine="If p.SdkVersion > 19 Then";
if (mostCurrent._p.getSdkVersion()>19) { 
 //BA.debugLineNum = 152;BA.debugLine="t.Enabled = True";
_t.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 154;BA.debugLine="Dim i As Int";
_i = 0;
 //BA.debugLineNum = 155;BA.debugLine="i = Msgbox2(\"Do you want to install\",\"Attention!\"";
_i = anywheresoftware.b4a.keywords.Common.Msgbox2("Do you want to install","Attention!","Yes","","No",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA);
...
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 159;BA.debugLine="If	File.Exists(File.DirRootExternal,\"traps.csv";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"traps.csv")==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 160;BA.debugLine="File.Copy(File.DirAssets,\"traps.csv\",File.DirRoot";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"traps.csv",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"traps.csv");
 ...
 //BA.debugLineNum = 163;BA.debugLine="If File.Exists(File.DirRootExternal,\"buildings.cs";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"buildings.csv")==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 164;BA.debugLine="File.Copy(File.DirAssets,\"buildings.csv\",File.Dir";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"buildings.csv",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"buildings.csv");
 ...
 //BA.debugLineNum = 168;BA.debugLine="ml.RootCmd(\"mount -o rw,remount /data\",\"\",Null,Nu";
mostCurrent._ml.RootCmd("mount -o rw,remount /data","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 169;BA.debugLine="ml.RootCmd(\"cp -r \"&File.DirRootExternal&\"/traps.";
mostCurrent._ml.RootCmd("cp -r "+anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/traps.csv data/data/com.supercell.clashofclans/update/logic/traps.csv","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 170;BA.debugLine="ml.RootCmd(\"cp -r \"&File.DirRootExternal&\"/buildi";
...
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"buildings.csv");
 //BA.debugLineNum = 177;BA.debugLine="Msgbox(\"COC Show Traps and Teslas Installed!\" & C";
anywheresoftware.b4a.keywords.Common.Msgbox("COC Show Traps and Teslas Installed!"+anywheresoftware.b4a.keywords.Common.CRLF+"Now, You can see all Traps and Teslas Before Attack","Completed",mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 179;BA.debugLine="Msgbox(\"Your Device not have Root Access\",\"Attent";
...
public static String  _b2_click() throws Exception{
 //BA.debugLineNum = 204;BA.debugLine="Sub b2_Click";
 //BA.debugLineNum = 205;BA.debugLine="If p.SdkVersion > 19 Then";
if (mostCurrent._p.getSdkVersion()>19) { 
 //BA.debugLineNum = 206;BA.debugLine="t.Enabled = True";
_t.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 208;BA.debugLine="ml.GetRoot";
mostCurrent._ml.GetRoot();
 //BA.debugLineNum = 209;BA.debugLine="If ml.HaveRoot Then";
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 210;BA.debugLine="ml.rm(\"data/data/com.supercell.clashofclans/updat";
mostCurrent._ml.rm("data/data/com.supercell.clashofclans/update/logic/traps.csv");
 //BA.debugLineNum = 211;BA.debugLine="ml.rm(\"data/data/com.supercell.clashofclans/updat";
mostCurrent._ml.rm("data/data/com.supercell.clashofclans/update/logic/buildings.csv");
 //BA.debugLineNum = 212;BA.debugLine="Msgbox(\"Original Restore Finished\" & CRLF & \"You";
anywheresoftware.b4a.keywords.Common.Msgbox("Original Restore Finished"+anywheresoftware.b4a.keywords.Common.CRLF+"You can Install again!","Completed!",mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 214;BA.debugLine="Msgbox(\"Your Device not have Root Access\",\"Attent";
anywheresoftware.b4a.keywords.Common.Msgbox("Your Device not have Root Access","Attention!",mostCurrent.activityBA);
 };
...
com.maximus.id.id _idd = null;
 //BA.debugLineNum = 76;BA.debugLine="Sub ct_Click";
 //BA.debugLineNum = 77;BA.debugLine="If p.SdkVersion > 19 Then";
if (mostCurrent._p.getSdkVersion()>19) { 
 //BA.debugLineNum = 78;BA.debugLine="t.Enabled = True";
_t.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 80;BA.debugLine="Dim lis As List";
_lis = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 81;BA.debugLine="Dim idd_int As Int";
_idd_int = 0;
 //BA.debugLineNum = 82;BA.debugLine="Dim idd As id";
_idd = new com.maximus.id.id();
 //BA.debugLineNum = 83;BA.debugLine="lis.Initialize";
_lis.Initialize();
 //BA.debugLineNum = 84;BA.debugLine="lis.AddAll(Array As String(\"Holo\",\"Holo Light\",\"H";
_lis.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{"Holo","Holo Light","Holo Light Dark","Old Android","Material","Material Light","Material Light Dark","Transparent","Transparent No Title Bar"}));
 //BA.debugLineNum = 85;BA.debugLine="idd_int = idd.InputList1(lis,\"Choose Themes!\")";
_idd_int = _idd.InputList1(_lis,"Choose Themes!",mostCurrent.activityBA);
 //BA.debugLineNum = 86;BA.debugLine="If idd_int = 0 Then";
if (_idd_int==0) { 
...
_settheme(mostCurrent._res.GetResourceId("style","android:style/Theme.Holo"));
 ...
 //BA.debugLineNum = 90;BA.debugLine="If idd_int = 1 Then";
if (_idd_int==1) { 
...
_settheme(mostCurrent._res.GetResourceId("style","android:style/Theme.Holo.Light"));
 ...
 //BA.debugLineNum = 94;BA.debugLine="If idd_int = 2 Then";
if (_idd_int==2) { 
...
_settheme(mostCurrent._res.GetResourceId("style","android:style/Theme.Holo.Light.DarkActionBar"));
 ...
 //BA.debugLineNum = 98;BA.debugLine="If idd_int = 3 Then";
if (_idd_int==3) { 
 //BA.debugLineNum = 99;BA.debugLine="SetTheme(16973829)";
_settheme((int) (16973829));
 };
 //BA.debugLineNum = 102;BA.debugLine="If idd_int = 4 Then";
if (_idd_int==4) { 
...
_settheme(mostCurrent._res.GetResourceId("style","android:style/Theme.Material"));
 ...
 //BA.debugLineNum = 106;BA.debugLine="If idd_int = 5 Then";
if (_idd_int==5) { 
...
_settheme(mostCurrent._res.GetResourceId("style","android:style/Theme.Material.Light"));
 ...
 //BA.debugLineNum = 110;BA.debugLine="If idd_int = 6 Then";
if (_idd_int==6) { 
...
_settheme(mostCurrent._res.GetResourceId("style","android:style/Theme.Material.Light.DarkActionBar"));
 ...
 //BA.debugLineNum = 114;BA.debugLine="If idd_int = 7 Then";
if (_idd_int==7) { 
...
_settheme(mostCurrent._res.GetResourceId("style","android:style/Theme.Translucent"));
 ...
 //BA.debugLineNum = 118;BA.debugLine="If idd_int = 8 Then";
if (_idd_int==8) { 
...
public static String  _settheme(int _theme) throws Exception{
 //BA.debugLineNum = 124;BA.debugLine="Private Sub SetTheme (Theme As Int)";
 //BA.debugLineNum = 125;BA.debugLine="If Theme = 0 Then";
if (_theme==0) { 
 //BA.debugLineNum = 126;BA.debugLine="ToastMessageShow(\"Theme not available.\", False)";
...
if (true) return "";
 ...
 //BA.debugLineNum = 129;BA.debugLine="If Theme = Theme_Value Then Return";
if (_theme==_theme_value) { 
if (true) return "";};
 //BA.debugLineNum = 130;BA.debugLine="Theme_Value = Theme";
_theme_value = _theme;
 //BA.debugLineNum = 131;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 132;BA.debugLine="StartActivity(Me)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,traps.getObject());
...
b4a.util.BClipboard _copy = null;
 ...
 //BA.debugLineNum = 61;BA.debugLine="If p.SdkVersion > 19 Then";
if (mostCurrent._p.getSdkVersion()>19) { 
 //BA.debugLineNum = 62;BA.debugLine="t.Enabled = True";
_t.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 64;BA.debugLine="Dim ShareIt As Intent";
_shareit = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 65;BA.debugLine="Dim copy As BClipboard";
_copy = new b4a.util.BClipboard();
 //BA.debugLineNum = 66;BA.debugLine="copy.clrText";
_copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 67;BA.debugLine="copy.setText(\"COC မွာျမန္မာစာေရးခ်င္ဖတ္ခ်င္ပါသလား?";
_copy.setText(mostCurrent.activityBA,"COC မွာျမန္မာစာေရးခ်င္ဖတ္ခ်င္ပါသလား? ၊ COC ကိုျမန္မာဘာသာျဖင့္ အသုံးျပဳခ်င္ပါသလား? ရန္သူစခန္းေတြမွာသြားတိုက္တဲ့အခါ ေထာင္ေခ်ာက္ေတြ ဗုံးေတြ၊ Teslas ႀကိဳတင္ေတြ႕ျမင္ခ်င္ပါသလား? ဒါေတြအားလုံးကို #COC_Myanmar_Tool တစ္ခုတည္းနဲ႔တင္လုပ္ေဆာင္နိုင္ပါၿပီ။ Root ေဖာက္ထားတဲ့မည္သည့္ Android ဖုန္းမဆိုအထက္ပါလုပ္ေဆာင္ခ်က္ေတြကို #COC_Myanmar_Tool ကထည့္သြင္းေပးနိုင္ပါတယ္။ Play Store ကေနအလြယ္တကူေဒါင္းယူရရွိနိုင္ပါတယ္။ Download Free at Google Play Store: https://play.google.com/store/apps/details?id=com.htetznaing.cocmmtool သို႔မဟုတ္မိမိတို႔ဖုန္းထဲက App Store တခုခုကေနလည္း ေဒါင္းနိုင္ပါတယ္။ ေဒါင္းဖို႔အဆင္မေျပသူမ်ားကေတာ့ ဒီမွာ သြားေဒါင္းနိုင္ပါတယ္ > http://ht3tzn4ing.blogspot.com/2016/12/COCMyanmarTool.html <");
 //BA.debugLineNum = 68;BA.debugLine="ShareIt.Initialize (ShareIt.ACTION_SEND,\"\")";
_shareit.Initialize(_shareit.ACTION_SEND,"");
 //BA.debugLineNum = 69;BA.debugLine="ShareIt.SetType (\"text/plain\")";
_shareit.SetType("text/plain");
 //BA.debugLineNum = 70;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(_copy.getText(mostCurrent.activityBA)));
 //BA.debugLineNum = 71;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.SUBJEC";
_shareit.PutExtra("android.intent.extra.SUBJECT",(Object)("#COC_Myanmar_Tool"));
 //BA.debugLineNum = 72;BA.debugLine="ShareIt.WrapAsIntentChooser(\"Share App Via...\"";
_shareit.WrapAsIntentChooser("Share App Via...");
 //BA.debugLineNum = 73;BA.debugLine="StartActivity (ShareIt)";
...
public static String  _t_tick() throws Exception{
 ...
 //BA.debugLineNum = 185;BA.debugLine="If	interstitial.Status=interstitial.Status_AdReady";
if (mostCurrent._interstitial.Status==mostCurrent._interstitial.Status_AdReadyToShow) { 
 //BA.debugLineNum = 186;BA.debugLine="interstitial.Show";
mostCurrent._interstitial.Show(mostCurrent.activityBA);
 };
 //BA.debugLineNum = 188;BA.debugLine="If interstitial.Status=interstitial.Status_Dismiss";
if (mostCurrent._interstitial.Status==mostCurrent._interstitial.Status_Dismissed) { 
 //BA.debugLineNum = 189;BA.debugLine="interstitial.Show";
mostCurrent._interstitial.Show(mostCurrent.activityBA);
 };
 //BA.debugLineNum = 191;BA.debugLine="t.Enabled = False";
_t.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 192;BA.debugLine="End Sub";
return "";
}
public static String  _t1_tick() throws Exception{
 //BA.debugLineNum = 194;BA.debugLine="Sub t1_Tick";
 //BA.debugLineNum = 195;BA.debugLine="If	interstitial.Status=interstitial.Status_AdReady";
if (mostCurrent._interstitial.Status==mostCurrent._interstitial.Status_AdReadyToShow) { 
 //BA.debugLineNum = 196;BA.debugLine="interstitial.Show";
mostCurrent._interstitial.Show(mostCurrent.activityBA);
 };
 //BA.debugLineNum = 198;BA.debugLine="If interstitial.Status=interstitial.Status_Dismiss";
if (mostCurrent._interstitial.Status==mostCurrent._interstitial.Status_Dismissed) { 
 //BA.debugLineNum = 199;BA.debugLine="interstitial.Show";
mostCurrent._interstitial.Show(mostCurrent.activityBA);
 };
 //BA.debugLineNum = 201;BA.debugLine="t1.Enabled = False";
