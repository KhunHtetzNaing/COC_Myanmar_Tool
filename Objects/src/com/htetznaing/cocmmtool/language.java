...
public class language extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.cocmmtool", "com.htetznaing.cocmmtool.language");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.cocmmtool", "com.htetznaing.cocmmtool.language");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.cocmmtool.language", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 42;BA.debugLine="bg.Initialize(LoadBitmap(File.DirAssets,\"language";
...
_i = 0;
 //BA.debugLineNum = 176;BA.debugLine="i = Msgbox2(\"What do you Install?\",\"Attention!\",\"";
_i = anywheresoftware.b4a.keywords.Common.Msgbox2("What do you Install?","Attention!","Zawgyi","","Unicode",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA);
...
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 180;BA.debugLine="If	File.Exists(File.DirRootExternal,\"texts.csv";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"texts.csv")==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 181;BA.debugLine="File.Copy(File.DirAssets,\"texts.csv\",File.DirRoot";
...
mostCurrent._ml.RootCmd("mount -o rw,remount /data","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 186;BA.debugLine="ml.RootCmd(\"cp -r \"&File.DirRootExternal&\"/texts.";
...
mostCurrent._ml.chmod("/data/data/com.supercell.clashofclans/update/csv/texts.csv",BA.NumberToString(666));
 //BA.debugLineNum = 188;BA.debugLine="File.Delete(File.DirRootExternal,\"texts.csv\")";
...
anywheresoftware.b4a.keywords.Common.Msgbox("COC Myanmar Language Installed!"+anywheresoftware.b4a.keywords.Common.CRLF+"Now, you can using with Myanmar Language","Completed",mostCurrent.activityBA);
 }else {
...
anywheresoftware.b4a.keywords.Common.Msgbox("Your Device not have Root Access","Attention!",mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 197;BA.debugLine="If i = DialogResponse.NEGATIVE Then";
if (_i==anywheresoftware.b4a.keywords.Common.DialogResponse.NEGATIVE) { 
 //BA.debugLineNum = 198;BA.debugLine="ml.GetRoot";
mostCurrent._ml.GetRoot();
 //BA.debugLineNum = 199;BA.debugLine="If ml.HaveRoot Then";
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 200;BA.debugLine="If	File.Exists(File.DirRootExternal,\"Utexts.cs";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Utexts.csv")==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 201;BA.debugLine="File.Copy(File.DirAssets,\"Utexts.csv\",File.DirRoo";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Utexts.csv",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Utexts.csv");
 ...
 //BA.debugLineNum = 205;BA.debugLine="ml.RootCmd(\"mount -o rw,remount /data\",\"\",Null,Nu";
mostCurrent._ml.RootCmd("mount -o rw,remount /data","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 206;BA.debugLine="ml.RootCmd(\"cp -r \"&File.DirRootExternal&\"/Utexts";
mostCurrent._ml.RootCmd("cp -r "+anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Utexts.csv data/data/com.supercell.clashofclans/update/csv/texts.csv","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 207;BA.debugLine="ml.chmod(\"/data/data/com.supercell.clashofclans/u";
mostCurrent._ml.chmod("/data/data/com.supercell.clashofclans/update/csv/texts.csv",BA.NumberToString(666));
 //BA.debugLineNum = 208;BA.debugLine="File.Delete(File.DirRootExternal,\"Utexts.csv\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Utexts.csv");
 //BA.debugLineNum = 209;BA.debugLine="Msgbox(\"COC Myanmar Language Installed!\" & CRLF &";
anywheresoftware.b4a.keywords.Common.Msgbox("COC Myanmar Language Installed!"+anywheresoftware.b4a.keywords.Common.CRLF+"Now, you can using with Myanmar Language","Completed",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 212;BA.debugLine="Msgbox(\"Your Device not have Root Access\",\"Attent";
anywheresoftware.b4a.keywords.Common.Msgbox("Your Device not have Root Access","Attention!",mostCurrent.activityBA);
 };
 };
...
public static String  _b2_click() throws Exception{
 //BA.debugLineNum = 217;BA.debugLine="Sub b2_Click";
 //BA.debugLineNum = 218;BA.debugLine="If p.SdkVersion > 19 Then";
if (mostCurrent._p.getSdkVersion()>19) { 
 //BA.debugLineNum = 219;BA.debugLine="t.Enabled = True";
_t.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 221;BA.debugLine="ml.GetRoot";
mostCurrent._ml.GetRoot();
 //BA.debugLineNum = 222;BA.debugLine="If ml.HaveRoot Then";
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 223;BA.debugLine="ml.rm(\"data/data/com.supercell.clashofclans/updat";
mostCurrent._ml.rm("data/data/com.supercell.clashofclans/update/csv/texts.csv");
 //BA.debugLineNum = 224;BA.debugLine="Msgbox(\"Original Restore Finished\" & CRLF & \"You";
anywheresoftware.b4a.keywords.Common.Msgbox("Original Restore Finished"+anywheresoftware.b4a.keywords.Common.CRLF+"You can install again!","Completed!",mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 226;BA.debugLine="Msgbox(\"Your Device not have Root Access\",\"Attent";
anywheresoftware.b4a.keywords.Common.Msgbox("Your Device not have Root Access","Attention!",mostCurrent.activityBA);
 };
